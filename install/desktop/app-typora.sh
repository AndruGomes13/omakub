...
ln -sf ~/.local/share/omakub/configs/typora/ia_typora.css ~/.config/Typora/themes/ia_typora.css
ln -sf ~/.local/share/omakub/configs/typora/ia_typora_night.css ~/.config/Typora/themes/ia_typora_night.css
